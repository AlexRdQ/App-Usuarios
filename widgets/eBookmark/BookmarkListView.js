  ...
  return declare([_WidgetBase, _TemplatedMixin, Evented], {
    ...
    addBookmarkNode: function(bookmark, level, toTableNode, parent) {
      ...
      if(bookmark.thumbnail){
        bookmarkThumbnailDiv = domConstruct.create("div", {
          "class": "thumbnail-div"
        }, bookmarkTdNode);
        thumbImg = domConstruct.create("img", {
          "class": "bookmark-thumb-img",
          "src": this.eBookmarkWidget.folderUrl + 'images/thumbnail.png',
          "title": this.nls.thumbPreview
        }, bookmarkThumbnailDiv);
      }
    ...
    _onRowThumbClick: function(bookmark, bookmarkTrNode, parent) {
      this.emit('onThumbClick', bookmarkTrNode, bookmark);
    },

    _onLayerNodeMouseover: function(bookmarkTrNode) {
      domClass.add(bookmarkTrNode, "bookmark-row-mouseover");
    },

    _onLayerNodeMouseout: function(bookmarkTrNode) {
      domClass.remove(bookmarkTrNode, "bookmark-row-mouseover");
    },
