...
define([
  ...
  function (declare, FilterListTemplate, array, html, lang, query, on, _WidgetsInTemplateMixin,
    ...
    return declare([BaseWidget, _WidgetsInTemplateMixin], {
      ...
      enableFilter: function (node, filterObj, parse) {
        ...
        if (!applied) {
          this._setItemFilter(layerId, idx, node.filterParams ?
            node.filterParams.getFilterExpr() : this._getFilterExpr(filterObj), filterObj.enableMapFilter);
      ...
      _getFilterExpr: function(filterObj){
